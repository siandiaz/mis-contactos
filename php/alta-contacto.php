<form id="alta-contacto" name="alta_frm" action="php/agregar-contacto.php" method="post" enctype="multipart/form-data">
	<fieldset>
		...
		<div>
			...
			<input type="email" id="mail" class="cambio" name="email_txt" placeholder="@email.com" title="Tu Email" required/>
		</div>
		<div>
		...
		<div>
			...
			<input type="number" id="telefono" class="cambio" name="telefono_txt" placeholder="Escribe tu teléfono" title="Tu Telefóno" required />
		</div>
		<div>
